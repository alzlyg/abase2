...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView greeting = (TextView) findViewById(R.id.temperature);
        greeting.setText(getWeather());
    ...
    private String getWeather(){
        ...
        return String.format("%s %s %s %s %s %s ", resources.getString(R.string.temperature), "-4",
                resources.getString(R.string.wet), "80%",
                resources.getString(R.string.wind), "5 м/с");
    }
